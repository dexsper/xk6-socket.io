...
Before asking a question, please check existing [issues](https://github.com/xemax32/xk6-socket.io/issues) and search online for solutions. If you still need help, clarification, or want to connect with the team and community, join our [community forums](https://community.grafana.com/c/grafana-k6).

## Reporting Bugs

Report bugs and errors using GitHub [issues](https://github.com/xemax32/xk6-socket.io/issues).
...
Feature requests are managed as GitHub [issues](https://github.com/xemax32/xk6-socket.io/issues).

Before submitting a new suggestion:

* Ensure you are using the latest version.  
* Carefully review the documentation to see if the functionality already exists.  
* Search existing [issues](https://github.com/xemax32/xk6-socket.io/issues) to avoid duplicates and add a comment if your idea is already present.  
...
1. Check existing [issues](https://github.com/xemax32/xk6-socket.io/issues) or create a new one to discuss your intended fix or feature.  
...
Use [mdcode] tool to update the socket.io code blocks in `README.md`
